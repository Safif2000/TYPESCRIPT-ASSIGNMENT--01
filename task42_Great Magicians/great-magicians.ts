...
let magician:string[]=['Harry Potter', 'Renaissance','Hermione  Granger','Ron weasley',"Albus Dumbledore"];

function make_great(magicArry:string[]){
     
    for(let i=0;i<magicArry.length;i++){
